...
#' Fisher's method can reject the joint null if any of the individual nulls are rejected with a sufficiently low p-value.
#' This method is only applicable for independent tests and no weights are considered.
#'
